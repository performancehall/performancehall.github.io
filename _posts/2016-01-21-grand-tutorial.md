...
Building the Grand Curtain is one of the more challenging and frustrating tasks
that exists in the tech world of the Performance Hall. While there are many steps
to getting it working that all have to be done correctly in order for the curtain
to work properly, none of them are particularly difficult on their own. It's important
to pay attention to and understand all the steps in isolation, as well as grasp the
larger project as a whole.

*Building the frame*

If you need to build the frame out, good luck to you. Here's the article for that:

###Curtain Carriers

First, place one of the carriers without a ring to each offstage end of the frame.

! - Image - !

These ring-less carriers may already be in place.

Now it's time to add the main carriers to the frame track. The carriers look like this.

! - Image - !

When putting them on the frame, make sure that the rotating frame piece with the hole is facing downstage! Place twenty seven (27) of these on each side of the frame. 
...
When set up properly, the rope forms a giant loop that connects through: the pulley on the floor (from where the curtain is operated),
the downstage stage left vertical pulley, the downstage curtain carriers, the stage right horizontal pulley, the upstage curtain carriers,
the upstage vertical pulley, and back down to the pulley on the floor.
...
If not for this, the rope would just move mostly unimpeded through the single carriers and the curtain would not move.
...
either closes or opens the curtain. This works because the rope is fixed at the master carriers. If you imagine a position at upstage center
to be 12 o clock, closing the curtain moves the rope and the carriers clockwise around the loop, and opening the curtain moves the rope/carriers
counterclockwise around the loop. The master carriers are hooked to the onstage edges of the curtain, and the single carriers are hooked onto the
rest of the grommets with the most offstage grommet hooked to a carrier that is secured behind a bracket on the track.
...
and cause the single carriers to pseudo-follow the rope as they follow the grommets on the curtain to which they are connected
as the curtain is gradually pulled taught. When the curtain is opened the master carriers will be pulled offstage and will
collide with the single carriers, pulling them offstage with it. This will pull the curtain along with the grommets
similar to the action when closing the curtain.
...
* The single and master curtain carriers - These live in a plastic bin in the stage right upstage wing
...
Okay, the first thing you need to do is remove the end stops from the onstage ends of the track.
...
(this is stage left of the offstage endstop and may be hard to see, as it's very close to the pulley). Feed the rope through all the big holes on the
singles carriers one after the other, making sure not to skip any.
...
Now have someone go to the downstage master carrier and pull the downstage master carrier as far onstage as it will go. Have the upstage person
...
or mostly taught, leaving a little slack place the rope into the gap between the metal posts on the downstage master carrier, and clamp the rope in place.
...
Begin by laying the curtain out flat (or as flat as it will get with its pleats). Pull the bottom corners taught, then the top corners.
Now make sure the center seam is relatively straight between the top and bottom of the curtain. Once the curtain is laid out, you can fold it.
...
Run and lift the curtain in a similar manner to how you would fold any other of our soft goods (try to catch air). Make sure that your fold aligns nicely
with the seam, and make sure the fold is about as flat as it can be, not overlapping on itself. Once you've checked that, fold the other side similarly.
...
Now take the other edge of the other side and fold it to the edge of the side you just folded (so over on itself). Once it's all folded, roll from
the bottom to the top. The roll will be pretty thick, but it should fit nicely in the bin. Once that's done, repeat the process for the other curtain.
